...
<body bgcolor="#F5DEB3">
  <form action="Result.php" method="post">
    ...
    <br><input type="text" name="user_query" class="search" value="<?php echo $_POST['user_keyword']; ?>"/>
    <input class="btn btn-basic" type="submit" name="search" value="Search Now">
